...
public class T4_SimpleDropdowns {
    ...
    public void simpleDropdownTest(){
       ...
       WebElement defaultCurrentSelection = simpleDropDown.getFirstSelectedOption();


       String actualSelectedText = defaultCurrentSelection.getText();
       String expectedSelectedText = "Please select an option";
