...
public class T1_xpath_cssSelector_practice {
    ...
    public static void main(String[] args) {
        ...
        WebElement header_ex1 = driver.findElement(By.cssSelector("div.example > h2"));
                                                                 //div[class='example'] is parent and ">" connects it to child h2
        ...
        //d. E-mail input box
        WebElement email_ex2 = driver.findElement(By.xpath("//input[@name='email']"));
        ...
        //d. E-mail input box
        WebElement inputBot_ex2 = driver.findElement(By.xpath("//input[contains(@pattern,'a-z')]"));
        ...
        System.out.println("emailLabel.isDisplayed() = " + email_ex1.isDisplayed());
